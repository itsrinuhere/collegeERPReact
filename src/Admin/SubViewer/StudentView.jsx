          ...
          <Grid item xs={2}sx={{width:20}}>
            ...
            data.map((i,index)=>{
              ...
              <Card 
                ...
                sx={{backgroundColor:"#00A9FF",opacity:0.9,margin:1,borderBlockColor:"#4F4A45",borderRadius:5}}>
                {/* */}
                <CardHeader
                  ...
                  <Grid container spacing={2}>
                      <Grid item xs={3}>
                          <Typography variant="body2" >
                            Batch: {i.batch?i.batch:"N/A"}
                          </Typography>
                      </Grid>
                      <Grid item xs={3}>
                          <Typography variant="body2">
                          {i.emailid?i.emailid:"N/A"}
                          </Typography>
                      </Grid>
                      <Grid item xs={3}>
                            <Typography variant="body2">
                            {i.mobile?i.mobile:"N/A"}
                            </Typography>
                      </Grid>
                      <Grid item xs={3}>
                            <Typography variant="body2">
                      ...
                      <Grid item xs={3}>
                            <Typography variant="body2">
                          Extra curriculars: {i.extracurricular?i.extracurricular:"N/A"}
                            </Typography>
                      </Grid>
                    </Grid>
                    </CardContent>
